...
namespace BadEcho.Presentation.Properties {
    ...
    internal class Strings {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The collection view model engine requires a valid collection change handler to be specified in the provided options..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to The context&apos;s dispatcher must be shut down due to an unhandled error caused by one of its components..
        /// </summary>
        internal static string ContextDispatcherError {
            get {
                return ResourceManager.GetString("ContextDispatcherError", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to The context&apos;s dispatcher has been manually shutdown..
        /// </summary>
        internal static string ContextDispatcherManuallyShutdown {
            get {
                return ResourceManager.GetString("ContextDispatcherManuallyShutdown", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to No dispatcher for the context has been initialized because the context has not yet been run..
        /// </summary>
        internal static string ContextHasNoDispatcher {
            get {
                return ResourceManager.GetString("ContextHasNoDispatcher", resourceCulture);
            }
        }
        ...
        internal static string NoNonClientAreaStateForTarget {
            get {
                return ResourceManager.GetString("NoNonClientAreaStateForTarget", resourceCulture);
            }
        }

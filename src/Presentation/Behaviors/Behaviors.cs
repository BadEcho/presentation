...
/// <summary>
/// Provides general-purpose behaviors that target and augment controls.
/// </summary>
public static class Behaviors
{
    /// <summary>
    /// Identifies the attached property that gets or sets a <see cref="DependencyObject"/> instance's collection of
    /// event triggers.
    /// </summary>
    ...
    /// <summary>
    /// Gets the value of the <see cref="EventTriggersProperty"/> attached property for a given <see cref="DependencyObject"/>.
    /// </summary>
    ...
    public static EventTriggerCollection GetEventTriggers(DependencyObject source) 
    ...
    /// <summary>
    /// Provides a compound behavior that hosts a collection of event triggers attached to a target dependency object.
    /// </summary>
    private sealed class EventTriggersBehavior : CompoundBehavior<FrameworkElement, EventTriggerCollection>
    {
        ...
        /// <param name="source">The dependency object from which the property value is read.</param>
        /// <returns>The collection of event triggers attached to <c>source</c>.</returns>
        public static EventTriggerCollection GetTriggers(DependencyObject source)
